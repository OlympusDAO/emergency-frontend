          ...
          <CardContent className="py-3 px-4 space-y-1.5">
              ...
              <div className="flex-1 min-w-0 space-y-1.5">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="inline-flex items-center gap-1.5 text-xs text-muted-foreground">
                    <span
                      className={`size-2 rounded-full ${SEVERITY_DOT_COLOR[component.severity] ?? "bg-gray-400"}`}
                    />
                    {component.severity}
                  </span>
                  {pendingProposal && (
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                {pendingProposal ? (
                  <Button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      window.open(pendingProposal.safeAppUrl, "_blank");
                    }}
                  >
                    <IconExternalLink className="size-3.5" />
                    Pending ({pendingProposal.confirmations}/{pendingProposal.threshold})
            ...
            <CollapsibleContent>
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                <div>
                  <p className="text-sm font-medium text-foreground mb-1">Available Networks</p>
                ...
                <div>
                  <p className="text-sm font-medium text-foreground mb-1">Shutdown Actions</p>
                  <div className="flex flex-wrap gap-1">
                    {component.calls.map((call) => (
                ...
                {component.shutdownCriteria.length > 0 && (
                  <div>
                    <p className="text-sm font-medium text-foreground mb-1">Shutdown Criteria</p>
