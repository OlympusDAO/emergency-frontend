...
export const CHAIN_ID_TO_NAME: Readonly<Record<ChainId, ChainName>> = {
  "1": "mainnet",
  "10": "optimism",
  "8453": "base",
  "42161": "arbitrum",
...
export const CHAIN_NAME_TO_ID: Readonly<Record<ChainName, ChainId>> = {
  "arbitrum": 42161,
  "base": 8453,
  "berachain": 80094,
  "mainnet": 1,
...
export const EMERGENCY_ADDRESSES: Readonly<Record<ChainId, ChainAddresses>> = {
  "1": {
    "chainId": 1,
    "contracts": {
...
} as Record<ChainId, ChainAddresses>;
